...
public class ModuleDao {
	...
	public List<ModuleDTO> getModulesByProductName(String productName) {
		...
		try {
			...
			if(product != null){
				Query<Module> moduleQuery = (Query<Module>) session.createQuery("from Module where product_id=:id AND parent_module_id=NULL", Module.class);
	...
	public List<ModuleDTO> getChildModulesByParentName(String parentName){
		...
		try {
			...
			if(module != null){
				Query<Module> moduleQuery = (Query<Module>) session.createQuery("from Module where parent_module_id=:id", Module.class);
